  ...
  render() {
    ...
    return (
      <Button
        ...
        buttonStyle={selected ? { backgroundColor: '#0099ff', borderRadius: 100, width: 127 } : { borderWidth: 1, borderColor: 'white', borderRadius: 30, width: 127, backgroundColor: 'transparent' }}
          ...
          <View style={{flex: 1, backgroundColor: 'rgba(47,44,60,1)'}}>
            ...
            <ScrollView style={{flex: 1}}>
              ...
              <View style={{flex: 1, flexDirection: 'row', marginTop: 20, marginHorizontal: 40, justifyContent: 'center', alignItems: 'center'}}>
                ...
                <Text style={{flex: 1, fontSize: 26, color: '#0099ff', fontFamily: 'bold', textAlign: 'right'}}>
                  K15
                </Text>
              </View>
              ...
              Trẻ trung, vui vẻ, yêu thương, trìu mến, trẻ trung, biết những gì cần để tạo ra mối quan hệ.
                </Text>
              </View>
              ...
              <Button
                ...
                buttonStyle={{ height: 55, borderRadius: 30, justifyContent: 'center', alignItems: 'center' }}
                linearGradientProps = {{
