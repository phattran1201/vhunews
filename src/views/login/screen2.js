  ...
  signup() {
    ...
    if (
      ...
      setTimeout(() => {
        ...
        Alert.alert('🔥', 'Giang hồ hiểm ác huynh đài cẩn thận')
      }, 1500)
    }
  }
    ...
    return !fontLoaded
      ? <Text> Loading... </Text>
        ...
        >
          ...
          >
            <Text style={styles.signUpText}>Gia Nhập Giang Hồ</Text>
            <Text style={styles.whoAreYouText}>Thiếu hiệp là ai ?</Text>
            <View style={styles.userTypesContainer}>
              <UserTypeItem
                label="Thiếu nữ đeo kính"
                labelColor="#ECC841"
                image={USER_COOL}
            ...
            <View style={{width: '80%', alignItems: 'center'}}>
              <FormInput
                ...
                placeholder="Quý danh hành hiệp"
                returnKeyType="next"
                errorMessage={usernameValid ? null : 'Bước chân ra giang hồ tên họ không được dấu'}
                onSubmitEditing={() => {
              ...
              <FormInput
                ...
                placeholder="Bản địa check hàng "
                keyboardType="email-address"
                returnKeyType="next"
                errorMessage={emailValid ? null : 'Hên là có check hàng ko là lỗ !'}
                onSubmitEditing={() => {
                  this.validateEmail()
              ...
              <FormInput
                ...
                placeholder="Thần chú đại pháp"
                secureTextEntry
                returnKeyType="next"
                errorMessage={passwordValid ? null : 'Bí kíp phải có khẩu quyết'}
                onSubmitEditing={() => {
              ...
              <FormInput
                ...
                placeholder="Khẩu quyết cho thần chú"
                secureTextEntry
                errorMessage={confirmationPasswordValid ? null : 'Bí kíp thần chú thất lạc '}
                returnKeyType="go"
                onSubmitEditing={() => {
          ...
          <View style={styles.loginHereContainer}>
            ...
            <Button
              ...
              onPress={() => Alert.alert('🔥', '36 kế chuồn là thượng sách')}
            />
          </View>
        </ScrollView>
  }
